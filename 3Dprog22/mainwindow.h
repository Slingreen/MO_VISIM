...
private slots:
    ...
    void on_task31Button_toggled(bool checked);
    void on_task32Button_toggled(bool checked);
    void on_PointCloudButton_toggled(bool checked);
    void on_TerrengButton_toggled(bool checked);
