...
{
   Vertex v0{v1.x(), v1.y(), v1.z(), v1.x(), v1.y(), v1.z()};    mVertices.push_back(v0);

   v0 = {v2.x(), v2.y(), v2.z(), v2.x(), v2.y(), v2.z()}; mVertices.push_back(v0);

   v0 = {v3.x(), v3.y(), v3.z(), v3.x(), v3.y(), v3.z()}; mVertices.push_back(v0);
}
